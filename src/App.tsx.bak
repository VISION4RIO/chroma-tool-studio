...
type ActiveTab = "assets" | "vfxRecolor" | "vfxLibrary";
        ...
        <section className="space-y-6">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
            <h2 className="text-xl font-medium text-white">
              {activeTab === "assets" ? "Asset Intake" : "VFX Recolor Intake"}
            </h2>
            {activeTab === "assets" ? (
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-1">
                ...
                >
                  Load Single .py for VFX Recolor
                </button>
              </div>
            )}
          ...
          {activeTab === "vfxRecolor" && (
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.06 }}>
              ...
              <div className="mt-6">
                <h3 className="text-lg font-medium text-white">Selected Python File</h3>
                ...
                <div className="mt-3 max-h-56 overflow-auto rounded-lg border border-white/10 bg-white/[0.03] p-2 text-xs text-zinc-300">
                  {!recolorFile ? (
                    <p className="text-zinc-500">No .py selected for recolor.</p>
                  ) : (
                    <div>
                      {(() => {
                ...
                {recolorFileKey && (
                  <div className="mt-3 rounded-lg border border-white/10 bg-black/30 p-3 text-xs text-zinc-300">
                    <p className="text-zinc-200">Selected file health check</p>
        ...
        >
          ...
          <div className="rounded-lg border border-white/10 bg-white/[0.04] p-4">
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="text-xs text-zinc-400">Auto prompt on build</span>
            </div>
            <div className="space-y-2">
